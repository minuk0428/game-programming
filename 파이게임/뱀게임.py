...
def paint(snake, message,count,a):
    """ 화면 전체 그리기 """
    count = a
    font = pygame.font.SysFont(None, 36)
    count_img = font.render("count {}".format(count),True,(255,255,255))

    SURFACE.fill((0, 0, 0))
    SURFACE.blit(count_img, (700, 250))
    snake.draw()
    for food in FOODS:
